...
class RingPullCoatingAnalysis1():
    ...
    def _side_image_angle_UI(self,n,side_img_zoom=[(None,None),(None,None)]):
        ...
        for n_i in n:
            ...
            f,ax = self.plot_side_img(n_i,side_img_zoom=side_img_zoom,side_view_col= self.side_view_col)       
            ...
            x_loc_top = -side_view_distance * self.scale+self.centroid[0] # mm * pixels/mm = pixel   
